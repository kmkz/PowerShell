<#
    Credits to @mattifestation for his awesome work on WMI and Powershell Fileless Persistence.
    This script is an adaptation of his work.
...
function Remove-Persistence{
    ...
    # Clean up Code - 
    # /!\ Comment this code out when you are installing persistence /!\
